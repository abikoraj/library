            ...
            <form action="{{ route('book.add') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" id="no" name="isbn" required class="form-control">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" id="days" name="qty" class="form-control">
                    </div>
                    <div class="col-md-3">
                        <label for="days">Price</label>
                        <input type="number" id="days" name="price" class="form-control">
                    </div>
                    <div class="col-md-3">
                        <label for="no">Code</label>
                        <input type="text" id="no" name="code" class="form-control">
                    </div>
                    <div class="col-md-3">
                        <label for="no">Edition</label>
                        <input type="text" id="no" name="edition" class="form-control">
                    </div>
                    <div class="col-md-3">
                        <label for="no">Publisher</label>
                        <input type="text" id="no" name="publisher" class="form-control">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea type="text" id="no" name="note" class="form-control"></textarea>
                    </div>
